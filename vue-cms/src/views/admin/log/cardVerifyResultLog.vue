<template>
  <div class="app-container">
    ...
    >
      ...
      />
      <el-table-column
        label="cardInfoOcrJson"
        align="center"
        :show-overflow-tooltip="true"
      >
        <template slot-scope="scope">
          <span>{{ scope.row.cardInfoOcrJson }}</span>
        </template>
      </el-table-column>
      <el-table-column label="cardVideo" align="center" prop="cardVideo" />
      <el-table-column
        label="passResult"
        align="center"
        prop="passResult"
      ...
      >
        <template slot-scope="scope">
          <!-- <el-button
            ...
            v-has-permi="['log:cardVerifyResult:update']"
            >修改</el-button
          > -->
          <el-button
            class="delete"
            ...
            v-has-permi="['log:cardVerifyResult:delete']"
            >删除</el-button
          >
        </template>
      </el-table-column>
...
import {
  getCardVerifyResultLog,
  delCardVerifyResultLog
...
export default {
  ...
  methods: {
    /** 查询字典类型列表 */
    getList() {
      getCardVerifyResultLog(this.queryParams).then(res => {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除编号为"' + Ids + '"的数据项?', "警告", {
        ...
        .then(function() {
          return delCardVerifyResultLog(Ids);
        })
        .then(() => {
          this.getList();
