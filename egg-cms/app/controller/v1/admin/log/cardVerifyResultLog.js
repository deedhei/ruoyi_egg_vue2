...
class Controller extends BaseController {
  constructor(...arg) {
    super(...arg);
    this.serviceName = "cardVerifyResultLog";
    this.modleName = "log";
  }
  // // 查询用户信息
  // async getInfo () {
  ...
  async create() {
    ...
    // );
    let query = {
      passResult: ctx.request.body["passResult"],
      cardVideo: ctx.request.body["cardVideo"],
      cardImage: ctx.request.body["cardImage"],
      cardInfoOcrJson: ctx.request.body["cardInfoOcrJson"],
